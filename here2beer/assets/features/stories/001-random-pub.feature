Feature: Random pub nearby
  ...
  Scenario Outline: Starting app gives a random pub around <place>
    ...
    Examples: 
      ...
      | Christ's College, Cambridge | 52.205277,0.121945  | Lola Lo,Baroosh,The Cow,Ta Bouche,DArrys Cookhouse & Wine Shop,Quinns Irish Pub,Cambridge City Hotel,Rat & Parrot,The Cambridge Brew House,The Bath House,All Bar One,Eraina Taverna,The Vaults Restaurant,Champion Of The Thames,The Regal,The Eagle,The King Street Run,Hidden Rooms,Clarendon Arms,The Fountain    |
      | Oundle, Northamptonshire    | 52.480902,-0.467577 | Rose and Crown,The Angel,The George                                                                                                                                                                                                                                                                                   |

  Scenario: User's location is unavailable
